...
class TextFieldComponentTest < ActiveSupport::TestCase
  ...
  test "renders a text input with the given name and ID" do
    render_inline(Primer::TextFieldComponent.new(**@default_params))
  ...
  test "visually hides the label" do
    render_inline(Primer::TextFieldComponent.new(**@default_params, show_label: false))
  ...
  test "renders in the large size" do
    render_inline(Primer::TextFieldComponent.new(**@default_params, size: :large))
  ...
  test "renders the component full-width" do
    render_inline(Primer::TextFieldComponent.new(**@default_params, full_width: true))

    assert_selector ".FormControl--fullWidth input"
  end

  test "marks the input as disabled" do
    render_inline(Primer::TextFieldComponent.new(**@default_params, disabled: true))

    assert_selector "input[disabled]"
  end

  test "marks the input as invalid" do
    render_inline(Primer::TextFieldComponent.new(**@default_params, invalid: true))

    assert_selector "input[invalid]"
  end

  test "renders the component with an inset style" do
    render_inline(Primer::TextFieldComponent.new(**@default_params, inset: true))

    assert_selector "input.FormControl-inset"
  end

  test "renders the component with a monospace font" do
    render_inline(Primer::TextFieldComponent.new(**@default_params, monospace: true))

    assert_selector "input.FormControl-monospace"
  end

  test "renders a leading visual icon" do
    render_inline(Primer::TextFieldComponent.new(**@default_params, leading_visual: { icon: :search }))
  ...
  test "renders a trailing label" do
    render_inline(Primer::TextFieldComponent.new(**@default_params, trailing_label: "bar"))
